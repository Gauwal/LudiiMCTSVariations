...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T83_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T83_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: Implicit Minimax | NST | Implicit Minimax | MaxAvgScore"
