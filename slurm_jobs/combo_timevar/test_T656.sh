...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T656_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T656_%j.err
#
#SBATCH --ntasks=1
...
echo "Game: Camelot"
echo "Variant: AG0 | Random | AlphaGo | MaxAvgScore"
