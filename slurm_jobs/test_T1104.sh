...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T1104_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T1104_%j.err
#
#SBATCH --ntasks=1
...
echo "Estimated: cpus=5, mem=7G, time=01:15:31"
