...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T343_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T343_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: AG0 | Heuristic Sampling | Implicit Minimax | Robust"
