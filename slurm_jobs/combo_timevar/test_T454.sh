...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T454_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T454_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: McBRAVE | Random | Qualitative | MaxAvgScore"
