...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T252_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T252_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: Implicit Minimax | HS Playout | AlphaGo | MaxAvgScore"
