...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T782_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T782_%j.err
#
#SBATCH --ntasks=1
...
echo "Estimated: cpus=5, mem=7G, time=09:11:40"
