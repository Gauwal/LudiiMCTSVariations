...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T231_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T231_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: Noisy AG0 | LGR | Heuristic | Robust"
