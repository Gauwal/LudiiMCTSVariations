...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T10_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/combo_timevar/results/planned_T10_%j.err
#
#SBATCH --ntasks=1
...
echo "Game: Ringo"
echo "Variant: AG0 | LGR | AlphaGo | MaxAvgScore"
