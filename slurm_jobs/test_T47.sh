...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T47_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T47_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: UCB1 | MAST | Implicit Minimax | Proportional Exp"
