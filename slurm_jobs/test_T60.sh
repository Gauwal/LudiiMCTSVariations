...
#SBATCH --output=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T60_%j.out
#SBATCH --error=/home/users/g/s/gsavary/LudiiMCTSVariations/slurm_jobs/results/planned_T60_%j.err
#
#SBATCH --ntasks=1
...
echo "Variant: Alpha-Beta | Random | Implicit Minimax | Proportional Exp"
